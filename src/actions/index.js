...
export const REQUEST_LEADER_STATS = 'REQUEST_LEADER_STATS'
export const RECEIVE_LEADER_STATS = 'RECEIVE_LEADER_STATS'
export const REQUEST_PLAYER_STATS = 'REQUEST_PLAYER_STATS'
export const RECEIVE_PLAYER_STATS = 'RECEIVE_PLAYER_STATS'

export const REQUEST_PLAYER_META = 'REQUEST_PLAYER_META'
export const RECEIVE_PLAYER_META = 'RECEIVE_PLAYER_META'
